...
def main():
    ...
    # Early stopping removed to avoid validation issues
    ...
    print(f"🖥️  Using accelerator: {accelerator}, devices: {devices}")
    ...
    trainer = pl.Trainer(
        ...
        precision=args.precision if accelerator == "gpu" else 32,  # Use 32-bit for CPU
        callbacks=callbacks,
        logger=loggers,
